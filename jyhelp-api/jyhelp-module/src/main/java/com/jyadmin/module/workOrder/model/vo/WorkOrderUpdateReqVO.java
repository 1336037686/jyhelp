 ...
 * @description: WorkOrderUpdateReqVO <br>
 */
@ApiModel("工单表-修改-数据模型")
@Data
public class WorkOrderUpdateReqVO implements Serializable {
     ...
     * 工单状态（待处理、已处理、不予解决）
     */
    @ApiModelProperty(value = "工单状态（待处理、已处理、不予解决）", name = "status")
